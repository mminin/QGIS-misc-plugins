...
#New above, template below
from PyQt4.QtCore import QSettings, QTranslator, qVersion, QCoreApplication
from PyQt4.QtGui import QAction, QIcon
# Initialize Qt resources from file resources.py
import resources
# Import the code for the dialog
from sort_layers_dialog import SortLayersDialog
import os.path
...
class SortLayers:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/SortLayers/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Sort Layers'),
            callback=self.run,
    ...
    def run(self):
        ...
        LayerNamesEnumDict=lambda listCh: {listCh[q[0]].layerName()+str(q[0]):q[1] for q in enumerate(listCh)}
